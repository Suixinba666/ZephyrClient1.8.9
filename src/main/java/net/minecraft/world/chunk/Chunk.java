...
public class Chunk {
     ...
     */
    public void removeEntityAtIndex(Entity entityIn, int coordY) {
        if (coordY < 0) {
            coordY = 0;
        }

        if (coordY >= this.entityLists.length) {
            coordY = this.entityLists.length - 1;
        }

        this.entityLists[coordY].remove(entityIn);
    }
