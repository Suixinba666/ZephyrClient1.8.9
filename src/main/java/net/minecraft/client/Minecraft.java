...
//        ZephyrLoadingScreen.init();
        ZephyrLoadingScreen.setProgress(0, "Minecraft - Init");
        this.skinManager = new SkinManager(this.renderEngine, new File(this.fileAssets, "skins"), this.sessionService);
        this.saveLoader = new AnvilSaveConverter(new File(this.mcDataDir, "saves"));
        ZephyrLoadingScreen.setProgress(10, "Minecraft - Init");
        ...
        ZephyrLoadingScreen.setProgress(20, "Minecraft - FontRenderer");
        ...
        ZephyrLoadingScreen.setProgress(30, "Minecraft - OpenGL Initialization");
        ...
        ZephyrLoadingScreen.setProgress(40, "Minecraft - Render Engine");
        this.renderEngine.loadTickableTexture(TextureMap.locationBlocksTexture, this.textureMapBlocks);
        this.textureMapBlocks.setBlurMipmapDirect(false, this.gameSettings.mipmapLevels > 0);
        ZephyrLoadingScreen.setProgress(42, "Minecraft - Model Manager");
        this.modelManager = new ModelManager(this.textureMapBlocks);
        this.mcResourceManager.registerReloadListener(this.modelManager);
        this.renderItem = new RenderItem(this.renderEngine, this.modelManager);
        ZephyrLoadingScreen.setProgress(44, "Minecraft - Render Manager");
        this.renderManager = new RenderManager(this.renderEngine, this.renderItem);
        this.itemRenderer = new ItemRenderer(this);
        this.mcResourceManager.registerReloadListener(this.renderItem);
        GlStateManager.popAttrib();
        ZephyrLoadingScreen.setProgress(46, "Minecraft - Entity Renderer");
        this.entityRenderer = new EntityRenderer(this, this.mcResourceManager);
        this.mcResourceManager.registerReloadListener(this.entityRenderer);
        this.blockRenderDispatcher = new BlockRendererDispatcher(this.modelManager.getBlockModelShapes(), this.gameSettings);
        this.mcResourceManager.registerReloadListener(this.blockRenderDispatcher);
        ZephyrLoadingScreen.setProgress(48, "Minecraft - Render Global");
        this.renderGlobal = new RenderGlobal(this);
        this.mcResourceManager.registerReloadListener(this.renderGlobal);
        this.guiAchievement = new GuiAchievement(this);
        ZephyrLoadingScreen.setProgress(50, "Minecraft - Finish");
        ...
        //CLIENT
        Zephyr.getInstance().startClient();
//        ZephyrLoadingScreen.notifyGameLoaded();
        //END CLIENT


        if (this.serverName != null) {
            this.displayGuiScreen(new GuiConnecting(ZephyrMainMenu.getMainMenu(), this, this.serverName, this.serverPort));
        } else {
            this.displayGuiScreen(ZephyrMainMenu.getMainMenu());
        }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        if (guiScreenIn == null && this.theWorld == null) {
            guiScreenIn = ZephyrMainMenu.getMainMenu();
        } else if (guiScreenIn == null && this.thePlayer.getHealth() <= 0.0F) {
            guiScreenIn = new GuiGameOver();
        }

        if (guiScreenIn instanceof ZephyrMainMenu) {
    ...
    protected void checkWindowResize() {
        if (!this.fullscreen && Display.wasResized()) {
            ...
            EventBus.call(new DisplayResizedEvent(i, j, this.displayWidth, this.displayHeight));
    ...
    public void clickMouse() {
        if (this.leftClickCounter <= 0 || ZephyrSettings.noClickDelay.getValue())
        {
            CPSUtils.addLeftCPS();
            this.thePlayer.swingItem();
...
//            boolean shouldHit = ModuleManager.autoClicker.shouldHit();

            while (Mouse.next() || !Mouse.scrollQueue.isEmpty())
            {
                int i = Mouse.getEventButton();

                KeyBinding.setKeyBindState(i - 100, Mouse.getEventButtonState());

                if (Mouse.getEventButtonState()/* || shouldHit*/)
                {
                ...
                if (i1 <= 200L)
                {
                    ...
                    if (j != 0 && this.currentScreen == null)
                    {
...
//            Mouse.nextDWheel();
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        //CLIENT
                        EventBus.call(new KeyPressedEvent(k));
                        //END CLIENT
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        EventBus.call(new WorldChangedEvent(worldClientIn));
