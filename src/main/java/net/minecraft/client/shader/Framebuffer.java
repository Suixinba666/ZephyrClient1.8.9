...
import tech.imxianyu.module.impl.render.ESP;
...
public class Framebuffer {
    ...
    //CLIENT
    public void framebufferRenderExtShaderESP(int p_178038_1_, int p_178038_2_, boolean p_178038_3_)
    {
        if (OpenGlHelper.isFramebufferEnabled())
        {
            GlStateManager.colorMask(true, true, true, false);
            ...
            if(ModuleManager.esp.isEnabled() && ModuleManager.esp.mode.getValue() == ESP.Mode.Shader){
                GlStateManager.color(ModuleManager.esp.color.getValue().getColor().getRed(),ModuleManager.esp.color.getValue().getColor().getGreen(),ModuleManager.esp.color.getValue().getColor().getBlue(),ModuleManager.esp.color.getValue().getColor().getAlpha());
            }else{
            ...
            WorldRenderer worldrenderer = tessellator.getWorldRenderer();
            worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
            worldrenderer.pos(0.0D, f1, 0.0D).tex(0.0D, 0.0D).color(ModuleManager.esp.color.getValue().getColor().getRed(),ModuleManager.esp.color.getValue().getColor().getGreen(),ModuleManager.esp.color.getValue().getColor().getBlue(),ModuleManager.esp.color.getValue().getColor().getAlpha()).endVertex();
            worldrenderer.pos(f, f1, 0.0D).tex(f2, 0.0D).color(ModuleManager.esp.color.getValue().getColor().getRed(),ModuleManager.esp.color.getValue().getColor().getGreen(),ModuleManager.esp.color.getValue().getColor().getBlue(),ModuleManager.esp.color.getValue().getColor().getAlpha()).endVertex();
            worldrenderer.pos(f, 0.0D, 0.0D).tex(f2, f3).color(ModuleManager.esp.color.getValue().getColor().getRed(),ModuleManager.esp.color.getValue().getColor().getGreen(),ModuleManager.esp.color.getValue().getColor().getBlue(),ModuleManager.esp.color.getValue().getColor().getAlpha()).endVertex();
            worldrenderer.pos(0.0D, 0.0D, 0.0D).tex(0.0D, f3).color(ModuleManager.esp.color.getValue().getColor().getRed(),ModuleManager.esp.color.getValue().getColor().getGreen(),ModuleManager.esp.color.getValue().getColor().getBlue(),ModuleManager.esp.color.getValue().getColor().getAlpha()).endVertex();
            tessellator.draw();
            this.unbindFramebufferTexture();
            GlStateManager.depthMask(true);
            GlStateManager.colorMask(true, true, true, true);
