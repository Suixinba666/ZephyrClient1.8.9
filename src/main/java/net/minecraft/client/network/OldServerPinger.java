            ...
            public void handleServerInfo(S00PacketServerInfo packetIn) {
                if (this.field_183009_e) {
                    ...
                    if (serverstatusresponse.getPlayerCountData() != null) {
                        server.populationInfo = Formatting.GRAY + String.valueOf(serverstatusresponse.getPlayerCountData().getOnlinePlayerCount()) + Formatting.DARK_GRAY + "/" + Formatting.GRAY + serverstatusresponse.getPlayerCountData().getMaxPlayers();
                    ...
                    protected void channelRead0(ChannelHandlerContext p_channelRead0_1_, ByteBuf p_channelRead0_2_) throws Exception {
                        ...
                        if (short1 == 255) {
                            ...
                            if ("\u00a71".equals(astring[0])) {
                                ...
                                server.populationInfo = Formatting.GRAY + String.valueOf(j) + Formatting.DARK_GRAY + "/" + Formatting.GRAY + k;
                            }
                        }
