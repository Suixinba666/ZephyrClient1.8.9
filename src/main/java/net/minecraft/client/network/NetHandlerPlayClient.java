...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn) {
        ...
        //CLIENT
        EventBus.call(new RespawnEvent());
        //END CLIENT
    }
    ...
    public void handleEntityMovement(S14PacketEntity packetIn) {
        ...
        if (entity != null) {
            ...
            entity.onGround = packetIn.getOnGround();
            EventBus.call(new EntityMovementEvent(entity, d0, d1, d2));
        }
    }
    ...
    public void onDisconnect(IChatComponent reason) {
        ...
        if (this.guiScreenServer != null) {
            ...
            this.gameController.displayGuiScreen(new GuiDisconnected(new ZephyrMultiPlayerUIDark(ZephyrMainMenu.getMainMenu()), "disconnect.lost", reason));
        }
    }
    ...
    public void handleTeams(S3EPacketTeams packetIn) {
        ...
        if (scoreplayerteam != null && (packetIn.getAction() == 0 || packetIn.getAction() == 2)) {
        ...
        if (scoreplayerteam != null && packetIn.getAction() == 1) {
