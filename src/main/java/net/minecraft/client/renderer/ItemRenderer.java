...
public class ItemRenderer
{
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0)
                {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                            BlockAnimationEvent event = EventBus.call(new BlockAnimationEvent(f,f1,f2,f3));
    ...
    private void renderFireInFirstPerson(float partialTicks)
    {
        ...
        for (int i = 0; i < 2; ++i)
        {
            ...
            float f8 = f7 + f;
            float f9 = -0.5F;
            GlStateManager.translate((float)(-(i * 2 - 1)) * 0.24F, ModuleManager.hud.fireY.getValue(), 0.0F);
