...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener {
    ...
    private static final Set<EnumFacing> SET_ALL_FACINGS = new HashSet<>(Arrays.asList(EnumFacing.VALUES));
    private int countTileEntitiesRendered;
    private IChunkProvider worldChunkProvider = null;
    private LongHashMap<? extends Chunk> worldChunkProviderMap = null;
    ...
    public RenderGlobal(Minecraft mcIn) {
        ...
        synchronized (ZephyrLoadingScreen.renderLock) {
            this.generateStars();
            this.generateSky();
            this.generateSky2();
        }
    ...
    public void renderEntityOutlineFramebuffer() {
        if (this.isRenderEntityOutlines()) {
            ...
            //CLIENT
            this.entityOutlineFramebuffer.framebufferRenderExtShaderESP(this.mc.displayWidth, this.mc.displayHeight, false);
            //END CLIENT
                ...
                if (!classinheritancemultimap.isEmpty())
                {
                    ...
                    while (true)
                    {
                        ...
                        while (true)
                        {
                            ...
                            if (entity2.isDead && entity2.posY < 90) {
                                if (AntiBots.isOnTab(entity2)) {
                                    iterator.remove();
                                    continue;
                                } else if (entity2.getDisplayName().getUnformattedText().equals("bot")) {
                                    iterator.remove();
                                    continue;
                                }
                            }
...
//                            System.out.println(entity2.hurtResistantTime);
//                            System.out.println(entity2.isDead);
//                            System.out.println(entity2.isEntityAlive());
//                            System.out.println(entity2.ticksExisted);
    ...
    public void playAuxSFX(EntityPlayer player, int sfxType, BlockPos blockPosIn, int data) {
        ...
        switch (sfxType) {
            ...
            case 2005 -> ItemDye.spawnBonemealParticles(this.theWorld, blockPosIn, data);
        }
    }
