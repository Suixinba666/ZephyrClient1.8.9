...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        try
        {
            ...
            if (entity == Minecraft.getMinecraft().thePlayer) {
                if (EventBus.canReceive(RenderPlayerRotationsEvent.class)) {
                    RenderPlayerRotationsEvent event = EventBus.call(new RenderPlayerRotationsEvent(Minecraft.getMinecraft().thePlayer.rotationYaw, Minecraft.getMinecraft().thePlayer.rotationPitch));
                    yaw = event.getRotationYaw();
                    pitch = event.getRotationPitch();
                    if (yaw != Minecraft.getMinecraft().thePlayer.rotationYaw || pitch != Minecraft.getMinecraft().thePlayer.rotationPitch) {
                        f = interpolateAngle(partialTicks, yaw, yaw);
                        f2 = interpolateAngle(partialTicks, yaw, yaw) - f;
                        f7 = lerp(partialTicks, pitch, pitch);
                    }
                }
    ...
    protected boolean setScoreTeamColor(T entityLivingBaseIn)
    {
        ...
        float f1 = (float)(i >> 16 & 255) * 0.003921568627451F;
        float f2 = (float)(i >> 8 & 255) * 0.003921568627451F;
        float f = (float)(i & 255) * 0.003921568627451F;
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor)
    {
        ...
        //CLIENT
        if (flag || flag1 || ModuleManager.antiInvisible.isEnabled())
        //END CLIENT
        {
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures)
    {
        ...
        else
        {
            ...
            {
                float f1 = (float)(i >> 24 & 255) * 0.003921568627451F;
                float f2 = (float)(i >> 16 & 255) * 0.003921568627451F;
                float f3 = (float)(i >> 8 & 255) * 0.003921568627451F;
                float f4 = (float)(i & 255) * 0.003921568627451F;
        ...
        if (this.canRenderName(entity))
        {
            ...
            if (d0 < (double)(f * f))
            {
                ...
                if (entity.isSneaking())
                {
                    ...
                    GlStateManager.rotate(this.renderManager.playerViewX * (Minecraft.getMinecraft().gameSettings.thirdPersonView == 2 ? -1 : 1), 1.0F, 0.0F, 0.0F);
    ...
    protected boolean canRenderName(T entity)
    {
        ...
        return Minecraft.isGuiEnabled() && !ModuleManager.nameTags.isEnabled() && (entity != this.renderManager.livingPlayer || ZephyrSettings.renderSelfNameTag.getValue()) && !entity.isInvisibleToPlayer(entityplayersp) && entity.riddenByEntity == null;
    }
