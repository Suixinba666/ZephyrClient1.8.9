...
import tech.imxianyu.rendering.waveycapes.layers.CustomCapeRenderLayer;
import tech.imxianyu.settings.ZephyrSettings;
import tech.imxianyu.widget.impl.PaperDoll;
    ...
    public void renderName(AbstractClientPlayer entity, double x, double y, double z) {
        if (this.canRenderName(entity))
        {
            ...
            if (d0 <= 4096)
            {
                ...
                if (!ZephyrSettings.nameTagNoBg.getValue()) {
