...
public class LayerHeldItem implements LayerRenderer<EntityLivingBase> {
    ...
    public void doRenderLayer(EntityLivingBase ent, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale) {
        ItemStack itemstack = ent.getHeldItem();
        ...
        if (itemstack != null) {
            ...
            minecraft.getItemRenderer().renderItem(ent, itemstack, ItemCameraTransforms.TransformType.THIRD_PERSON);
