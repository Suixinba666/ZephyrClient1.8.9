...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(final float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            final Vec3 eyesVec = entity.getPositionEyes(partialTicks);
            boolean flag = false;
            double reach = ModuleManager.reach.isEnabled() ? ModuleManager.reach.range.getValue() : 3.0D;
            float expand = 0;
            ...
            if (this.mc.objectMouseOver != null) {
                distance = this.mc.objectMouseOver.hitVec.distanceTo(eyesVec);
            }
            ...
            final Vec3 lookVec = entity.getLook(partialTicks);
            final Vec3 rangeSearch = eyesVec.addVector(lookVec.xCoord * reach, lookVec.yCoord * reach, lookVec.zCoord * reach);
            Entity pointedEntity = null;
            Vec3 vec33 = null;
            final float f = 1.0F;
            final List<Entity> list = this.mc.theWorld.getEntitiesInAABBexcluding(entity, entity.getEntityBoundingBox().addCoord(lookVec.xCoord * reach, lookVec.yCoord * reach, lookVec.zCoord * reach).expand(f, f, f), Predicates.and(EntitySelectors.NOT_SPECTATING, Entity::canBeCollidedWith));
            double d2 = distance;
            ...
            for (final Entity entity1 : list) {
                ...
                final MovingObjectPosition movingobjectposition = axisalignedbb.calculateIntercept(eyesVec, rangeSearch);

                if (axisalignedbb.isVecInside(eyesVec)) {
                    if (d2 >= 0.0D) {
                        pointedEntity = entity1;
                        vec33 = movingobjectposition == null ? eyesVec : movingobjectposition.hitVec;
                        d2 = 0.0D;
                    }
                } else if (movingobjectposition != null) {
                    final double d3 = eyesVec.distanceTo(movingobjectposition.hitVec);
...
//            System.out.println(pointedEntity == null ? "NULL" : pointedEntity.getName());

            if (pointedEntity != null && flag && vec33 != null && eyesVec.distanceTo(vec33) > reach) {
                pointedEntity = null;
            ...
            if (pointedEntity != null && (d2 < distance || this.mc.objectMouseOver == null)) {
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime) {
        ...
        //CLIENT
        if (Perspective.overrideMouse() && (flag/* || EventBus.canReceive(MouseXYChangeEvent.class)*/))
        {
...
//                this.renderEndNanoTime = System.nanoTime();
            ...
            else
            {
                ...
                //CLIENT
                if(this.mc.currentScreen instanceof ZephyrScreen){
...
//                this.renderEndNanoTime = System.nanoTime();
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                try
                {
                    ...
                    if(this.mc.currentScreen instanceof ZephyrScreen){
                        ...
                        ((ZephyrScreen) this.mc.currentScreen).drawScreen(k1 * RenderSystem.getScaleFactor(), l1 * RenderSystem.getScaleFactor());
                        GlStateManager.popMatrix();
                    ...
                    RenderSystem.RenderingTimes.screen = took;
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        //CLIENT
        GL11.glPushMatrix();
        this.mc.mcProfiler.startSection("render3d");
        EventBus.call(new Render3DEvent(partialTicks));
        this.mc.mcProfiler.endSection();
