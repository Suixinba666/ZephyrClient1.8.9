...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
    ...
    /**
     * Causes the screen to lay out its subcomponents again. This is the equivalent of the Java getDebugInfoLeft
     * Container.validate()
     */
    ...
    public void handleInput() throws IOException {
        ...
        if (Keyboard.isCreated()) {
            ...
            while (Keyboard.next()) {
                ...
                if (eventKeyState) {
                    this.handleKeyboardInput(eventCharacter, k);
                }
     ...
     */
    public void handleKeyboardInput(char c0, int eventKey) throws IOException
    {
        //CLIENT
//        System.out.println("KeyTyped");
//        DevUtils.printCurrentInvokeStack();
        this.keyTyped(c0, eventKey);
        //END CLIENT

        this.mc.dispatchKeypresses(c0, eventKey);
    }
