...
{
    private static final ResourceLocation widgetsTextureLocation = new ResourceLocation("textures/gui/widgets.png");
    public static final ResourceLocation spectatorWidgetsTextureLocation = new ResourceLocation("textures/gui/spectator_widgets.png");
    ...
    protected void func_175258_a(ScaledResolution p_175258_1_, float p_175258_2_, int p_175258_3_, float p_175258_4_, SpectatorDetails p_175258_5_)
    {
        ...
        this.mc.getTextureManager().bindTexture(widgetsTextureLocation);
    ...
    {
        this.mc.getTextureManager().bindTexture(spectatorWidgetsTextureLocation);
