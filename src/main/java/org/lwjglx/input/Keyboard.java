...
public class Keyboard {
    ...
    private static char[] keyEventChars = new char[257];
    ...
    public static void addKeyEvent(int key, int pressed) {
        ...
        if (pressed == GLFW.GLFW_REPEAT && !repeat_enabled)
            return;

        int lwjglKey = KeyCodes.toLwjglKey(key);
        keyEvents[queue.getNextPos()] = lwjglKey;
    ...
    private static void addUnicodeKeyEvent() {
        keyEvents[queue.getNextPos()] = 0xff0090ff;
    ...
    static ConcurrentLinkedQueue<Character> unicodeChars = new ConcurrentLinkedQueue<>();
...
//            System.out.println("Unicode");
    ...
    public static char getEventCharacter() {
        ...
        if (eventKey == 0xff0090ff && !unicodeChars.isEmpty()) {

//            if (unicodeChars.size() == 1)
//                DevUtils.printCurrentInvokeStack();
            Character poll = unicodeChars.poll();
...
//            System.out.println("Poll: " + poll);
        ...
        return keyEventChars[eventKey];
    }

    public static boolean getEventKeyState() {

        if (unicodeChars.size() > 0) {
//            System.out.println(Arrays.toString(unicodeChars.toArray(new Character[0])));
            return true;
        }

//        System.out.println(keyEventStates[queue.getCurrentPos()]);
