package tech.imxianyu.gui.multiplayerdark.dialog;
...
public abstract class Dialog {
    ...
    public abstract void render(double mouseX, double mouseY, ZephyrMultiPlayerUIDark inst);
    ...
    protected void drawBackgroundMask(ZephyrMultiPlayerUIDark inst) {
