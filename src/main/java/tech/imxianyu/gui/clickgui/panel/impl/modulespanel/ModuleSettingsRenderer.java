package tech.imxianyu.gui.clickgui.panel.impl.modulespanel;
 ...
 */
public class ModuleSettingsRenderer {
    ...
    public ModuleSettingsRenderer(Module module) {
        this.module = module;
    }
...
//        RenderSystem.doScissor((inta) x, (int) y, (int) pWidth, (int) pHeight);
        ...
        fr25.drawString(module.getName(), x, y, -1);
