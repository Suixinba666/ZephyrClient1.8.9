...
public class SettingsPanel extends Panel {
    ...
    public void draw(double posX, double posY, double width, double height, double mouseX, double mouseY, int dWheel) {
        ...
        unicodeRenderer.drawString("Settings", posX, posY, -1);

//        RoundedRect.drawRound();

        double x = posX, y = posY + unicodeRenderer.getHeight() / 2.0, pWidth = width, pHeight = height;
...
//            Rect.draw(x, y + fr25.getHeight(), pWidth, pHeight - 24, -1, Rect.RectType.EXPAND);
            ...
            List<Setting<?>> settings = ZephyrSettings.getSettings();
