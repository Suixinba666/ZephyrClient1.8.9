...
public class ServerInfoDialog extends Dialog {
    ...
    public void render(double mouseX, double mouseY, ZephyrMultiPlayerUI inst) {
        ...
        RoundedRect.drawRound(x, y, width, height, 16, new Color(255, 255, 255, intAlpha));

        titleRenderer.drawString("Server Name", x + 32, y + 25, RenderSystem.hexColor(0, 0, 0, intAlpha));

        RoundedRect.drawRound(x + 30, y + 25 + 7 + titleRenderer.getHeight(), width - 60, 24, 8, new Color(245, 245, 245, intAlpha));
        ...
        name.height = 14;
        name.setTextColor(RenderSystem.hexColor(96, 96, 96));
        name.drawTextBox((int) mouseX, (int) mouseY);

        titleRenderer.drawString("Server Address", x + 32, y + 32 + 24 + 15 + titleRenderer.getHeight(), RenderSystem.hexColor(0, 0, 0, intAlpha));

        RoundedRect.drawRound(x + 30, y + 32 + 24 + 15 + 7 + titleRenderer.getHeight() * 2, width - 60, 24, 8, new Color(245, 245, 245, intAlpha));
        ...
        address.height = 14;
        address.setTextColor(RenderSystem.hexColor(96, 96, 96));
        address.drawTextBox((int) mouseX, (int) mouseY);

        titleRenderer.drawString("Server Resource Pack", x + 32, y + 32 + 24 + 15 + 46 + 14 + titleRenderer.getHeight(), RenderSystem.hexColor(0, 0,0, intAlpha));
        ...
        RoundedRect.drawRound(selectorX - 2, selectorY, selectorWidth + 1, selectorHeight, 5, new Color(245, 245, 245, intAlpha));
        ...
        for (ResourceMode option : options) {
            ...
            if (indexOf == resourcePackMode) {
                RoundedRect.drawRound(offsetX - 3, selectorY + 2, 6 + optionsRenderer.getStringWidth(option.name), 14, 3, new Color(255, 255, 255, intAlpha));
            } else {
            ...
            optionsRenderer.drawString(option.name, offsetX - 0.5, selectorY + selectorHeight * 0.5 - optionsRenderer.getHeight() * 0.5, RenderSystem.hexColor(0, 0, 0));
        ...
        RoundedRect.drawRound(x + 30, y + height - 46, (width - 68) * 0.5, 20, 3, (!name.getText().isEmpty() && !address.getText().isEmpty()) ? new Color(94, 169, 255, intAlpha) : new Color(190, 190, 190, intAlpha));

        FontManager.pf20.drawCenteredString("Done", x + 30 + (width - 68) * 0.25, y + height - 36 - FontManager.pf20.getHeight() * 0.5, RenderSystem.hexColor(255, 255, 255, intAlpha));
        ...
        RoundedRect.drawRound(x + (width - 68) * 0.5 + 38, y + height - 46, (width - 68) * 0.5, 20, 3, new Color(245, 245, 245, intAlpha));

        FontManager.pf20.drawCenteredString("Cancel", x + 34 + (width - 60) * 0.75, y + height - 36 - FontManager.pf20.getHeight() * 0.5, RenderSystem.hexColor(0, 0, 0, intAlpha));
