...
public enum ESP2D {
    ...
    public void renderBox(Minecraft mc) {
        ...
        double twoDscale = RenderSystem.getScaleFactor() / Math.pow(RenderSystem.getScaleFactor(), 2.0);
        ...
        for (Entity entity : this.entityConvertedPointsMap.keySet()) {
            ...
            if (!ModuleManager.esp.invisible.getValue()) {
                if (ent.isInvisible())
                    continue;
            }
            ...
            if (!(ent instanceof EntityPlayerSP)) {
                ...
                try {
                    ...
                    final int color = Color.GRAY.getRGB();

                    if (ModuleManager.esp.box.getValue()) {
                    ...
                    if (ModuleManager.esp.health.getValue()) {
                        ...
                        Color customColor = health >= 0.0f ? blendColors(fractions, colors, progress).brighter()
                                : Color.RED;
                        if (ModuleManager.esp.healthColorMode.getValue() == ESP.HealthColorMode.Static)
                        ...
                        if ((int) this.getIncremental(progress * 100.0f, 1.0) <= 100) {
                            ...
                            if (ModuleManager.esp.tags.getValue()) {
                                String nigger = (int) getIncremental(health * 5.0f, 1.0) + "HP";
                                FontManager.pf14.drawString(nigger, (float) (x - (double) (FontManager.pf14.getStringWidth(nigger) * 2.0f)) / 2.0f - 5, ((float) (strHealthLocation) + FontManager.pf14.getHeight() / 2.0f) / 2.0f - 2, -1);
                                FontManager.pf14.drawStringWithShadow(nigger, (float) (x - (double) (FontManager.pf14.getStringWidth(nigger) * 2.0f)) / 2.0f - 5, ((float) (strHealthLocation) + FontManager.pf14.getHeight() / 2.0f) / 2.0f - 2, -1);
                            }
                    ...
                    if (ModuleManager.esp.armor.getValue()) {
                        if (stack1 != null) {
                            ...
                            rectangle(endx + 2, y + var1 - 1, endx + 5, y + var1 - 1 - (diff1 * percent),
                                    getColor(78, 206, 229));
                            if (ModuleManager.esp.tags.getValue()) {
                                this.drawStringWithShadow(String.valueOf(stack1.getMaxDamage() - stack1.getItemDamage()), endx + 7, (y + var1 - 1 - (diff1 / 2)) - (mc.fontRendererObj.FONT_HEIGHT / 2), -1);
                            }
                        }
                        ...
                        if (stack2 != null) {
                            ...
                            rectangle(endx + 2, (y + var1 * 2), endx + 5, (y + var1 * 2) - (diff1 * percent),
                                    getColor(78, 206, 229));
                            if (ModuleManager.esp.tags.getValue()) {
                                this.drawStringWithShadow(String.valueOf(stack2.getMaxDamage() - stack2.getItemDamage()), endx + 7,
                        ...
                        if (stack3 != null) {
                            ...
                            rectangle(endx + 2, (y + var1 * 3), endx + 5, (y + var1 * 3) - (diff1 * percent),
                                    getColor(78, 206, 229));
                            if (ModuleManager.esp.tags.getValue()) {
                                this.drawStringWithShadow(String.valueOf(stack3.getMaxDamage() - stack3.getItemDamage()), endx + 7,
                        ...
                        if (stack4 != null) {
                            ...
                            rectangle(endx + 2, (y + var1 * 4) - 1, endx + 5, (y + var1 * 4) - (diff1 * percent),
                                    getColor(78, 206, 229));
                            if (ModuleManager.esp.tags.getValue()) {
                                this.drawStringWithShadow(String.valueOf(stack4.getMaxDamage() - stack4.getItemDamage()), endx + 7,
    ...
    public void rectangle(double left, double top, double right, double bottom, int color) {
        ...
        float var6 = (float) (color >> 16 & 255) * 0.003921568627451F;
        float var7 = (float) (color >> 8 & 255) * 0.003921568627451F;
        float var8 = (float) (color & 255) * 0.003921568627451F;
