...
/**
 * @author ImXianyu
 * @since 2022/7/16 10:00
 */
public class InvUtils {
    private static final Minecraft mc = Minecraft.getMinecraft();

    private static final List<Block> blacklist = Arrays.asList(Blocks.air, Blocks.water, Blocks.flowing_water, Blocks.lava,
            Blocks.flowing_lava, Blocks.tnt, Blocks.sand, Blocks.enchanting_table, Blocks.beacon, Blocks.noteblock,
            Blocks.sand, Blocks.chest, Blocks.gravel, Blocks.ender_chest);
    ...
    public static List<ItemStack> getAllInventoryContent() {
        List<ItemStack> result = new ArrayList<>(Arrays.asList(mc.thePlayer.inventory.mainInventory).subList(0, 36));
        for (int i = 0; i < 4; i++) {
    ...
    public static List<ItemStack> getInventoryAndHotBarContent() {
        return new ArrayList<>(Arrays.asList(mc.thePlayer.inventory.mainInventory));
    }

    public static List<ItemStack> getInventoryContent() {
        return new ArrayList<>(Arrays.asList(mc.thePlayer.inventory.mainInventory).subList(9, 36));
    }
